...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_cred = Credentials("GitHub", "andersoking77@gmail.com", "#pull@p77")
    def tearDown(self):
        '''
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_cred.email, "andersoking77@gmail.com")
        self.assertEqual(self.new_cred.passlock, "#pull@p77")
    ...
    def test_copy_password(self):
        ...
        '''
        self.new_cred.save_cred()
        Credentials.copy_passlock("#pull@p77")
